...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    CreateProjDialog: typeof import('./src/components/VmIde/pages/ide/dialog/CreateProjDialog.vue')['default']
    DebugPyBtn: typeof import('./src/components/VmIde/pages/ide/topmenu-items/DebugPyBtn.vue')['default']
    DebugPyDialog: typeof import('./src/components/VmIde/pages/ide/dialog/DebugPyDialog.vue')['default']
